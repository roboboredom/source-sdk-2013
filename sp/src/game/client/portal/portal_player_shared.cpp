...
void CPortal_Player::SuppressCrosshair(bool inValue)
{
	crosshairSuppressed = inValue;
}

bool CPortal_Player::IsSuppressingCrosshair(void)
{
	return crosshairSuppressed;
}
